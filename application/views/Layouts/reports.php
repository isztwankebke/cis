    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="<?php echo $scriptName == "index" ? 'active' : ''; ?>"><a href="/clients/read">Lista klientów<span class="sr-only">(current)</span></a></li>
            <li class="<?php echo $scriptName == "addClient" ? 'active' : ''; ?>"><a href="/clients/addClient">Lista transakcji<span class="sr-only">(current)</span></a></li>
            <li class="<?php echo $scriptName == "search" ? 'active' : ''; ?>"><a href="/clients/search">Raport na bieżący tydzień<span class="sr-only">(current)</span></a></li>
            <li class="<?php echo $scriptName == "reports" ? 'active' : ''; ?>"><a href="dashboards/index">Raport na przyszły tydzień<span class="sr-only">(current)</span></a></li>
            <li class="<?php echo $scriptName == "search" ? 'active' : ''; ?>"><a href="/clients/search">Raport za okres<span class="sr-only">(current)</span></a></li>
          </ul>
          <ul class="nav nav-sidebar">
